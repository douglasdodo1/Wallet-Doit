...
const PaymentListController = () => {
    ...
    const updatePaymentList = async(req, res) => {
        try {
            ...
            const paymentUpdated = await paymentListService.updatePayment(paymentToUpdated,paymentId);
    ...
    const deletePaymentList = async(req, res) => {
        try {
            ...
            const paymentDeleted = await paymentListService.deletePayment(paymentTodelete.id);
    ...
    return {
        createPaymentList, readPaymentList,readAllpaymentList ,updatePaymentList, deletePaymentList
    }
}
